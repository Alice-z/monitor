...
<script>
  ...
  export default {
    ...
    computed:mapState({
      newProject:(state)=> state.project.newProject
    }) ,
    methods: {
      overlaycomplete(e) {
        ...
        this.newProject.polygon.center = {lng ,lat }
        this.showMsg = true;
        this.overlays = e.overlay;
        console.log(e.overlay);
        this.newProject.polygon.path = path;
        this.newProject.polygon.zoom = this.map.getZoom();
        this.$confirm('创建新的项目', {
